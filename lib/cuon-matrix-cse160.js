...
class Vector3 {
    ...
    static dot(other1, other2) {
        ...
        var res1 = other1.elements;
        var res2 = other2.elements;
    ...
    static cross(other1, other2) {
        ...
        v3.elements[0] =      (a[1] * b[2]) - (b[1] * a[2]); 
        v3.elements[1] = 0 - ((a[0] * b[2]) - (b[0] * a[2]));
        v3.elements[2] =      (a[0] * b[1]) - (b[0] * a[1]);
        // Don't delete the return statement.
        return v3;
    }
